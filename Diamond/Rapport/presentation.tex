...
%    \hfill%
    ...
    \begin{figure}
    \includegraphics[scale=0.10]{Images/michelangelo}
...
\vspace{-1em}
    \end{figure}
     \begin{figure}
    \includegraphics[scale=0.08]{Images/ball}
...
\vspace{-1em}
    \end{figure}
     \begin{figure}
    \includegraphics[scale=0.11]{Images/T_V_3D}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[scale=0.26]{Images/boundary_RPT}
  \caption{}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[scale=0.36]{Images/T_time}
  \caption{}
\end{subfigure}
\caption{\textbf{Gauche} : Evolution du nombre de références par tétraèdre (RPT) en fonction de la part de tétraèdres sur les bords du maillage. \textbf{Droite} : Temps en secondes (s) du parcous en largeur en fonction du nombre de tétraèdres.}
\end{figure}
