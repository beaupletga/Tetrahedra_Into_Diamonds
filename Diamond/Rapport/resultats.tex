...
%\addplot coordinates {(3k,)(83k)(125k)(156k)(2.2M)(8.1M)(10.3M)};
\legend{Structure Compacte,Structure de données non Compacte (4 rpt)}
\end{axis}
\end{tikzpicture}
...
%
%
%taille du tableau de la structure compacte
%B1 9234  14332
%B2 199262 333648
%B3 5291508 8.97e6
%B4 19212158 3.26e7
