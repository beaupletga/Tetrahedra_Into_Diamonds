...
\addplot coordinates {(Accès au ième tétraèdre,2.5e-3)(Degré d'un sommet,5.2e-4)(Parcours en Largeur,0.17)};
\addplot coordinates {(Accès au ième tétraèdre,1.8e-3)(Degré d'un sommet,1.9e-4)(Parcours en Largeur,0.36)};
%\addplot coordinates {(3.9,2.36)(4.29,2.38)(4.43,2.34)(4.93,2.29)(5.08,)(5.10,)(5.11,) };
\legend{Structure Compacte,Structure non Compacte,Structure avec Pointeurs}
\end{axis}
\end{tikzpicture}
\caption{Comparaison des temps moyens (s) requis pour répondre aux requêtes avec notre structure de données compacte, une structure de données compacte utilisant 4 rpt (i.e SOT) et une structure de données compacte utilisant les pointeurs}
