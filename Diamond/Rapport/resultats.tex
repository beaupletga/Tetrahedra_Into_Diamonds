...
\end{axis}
\end{tikzpicture}
\caption{Comparaison des temps moyens (s) requis pour répondre aux requêtes avec notre structure de données compacte, une structure de données compacte utilisant 4 rpt (i.e SOT) et une structure de données compacte utilisant les pointeurs. Le temps pour le parcours en largeur est normalisé pour 100 000 tétraèdres.}
...
%    ymode = log,
    ...
    symbolic x coords={2.2M,8.1M,10.3M},
    xtick=data,
    nodes near coords,
    nodes near coords align={vertical},
    ]
...
\addplot coordinates {(2.2M,5.2)(8.1M,19.2)(10.3M,24.4)};
\addplot coordinates {(2.2M,8.9)(8.1M,32.6)(10.3M,41.4)};
