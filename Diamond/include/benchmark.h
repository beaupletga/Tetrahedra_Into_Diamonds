...
void time_to_compute_BFS(int diamond_array[],bool diamond_extra_bytes_array[],int array_size,vector<tuple<int,int,int>> &permutation_array,vector<tuple<int,int,int>> &face_array,int vertex_number);
