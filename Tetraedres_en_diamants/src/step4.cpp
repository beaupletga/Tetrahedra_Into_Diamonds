...
map<int,int> step_4(vector<Tetrahedron> &tetra_list,vector<Diamond> &diamond_list,int (diamond_array)[],
bool (diamond_extra_bytes_array)[],int diamond_array_size,map<int,Diamond*> &anchor_dict
